...
/*   Updated: 2023/09/03 14:50:24 by amurcia-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_third_degree(t_letters let)
{
    ...
    else if (discriminant == 0)
    {
        ...
        s = -let.b / (3 * let.a);
        t = -let.b / (3 * let.a);
        printf("Una raíz real y dos raíces complejas conjugadas:\n");
        printf("x1 = %.4lf\n", r + s + t);
        printf("x2 = %.4lf + %.4lfi\n", -(r + s) / 2, sqrt(3) * (r - s) / 2);
        printf("x3 = %.4lf - %.4lfi\n", -(r + s) / 2, sqrt(3) * (r - s) / 2);
    }
    else
    {
        ...
        t = sqrt(-(p / 3));
        u = acos(-(s / (2 * t)));
        printf("Tres raíces reales iguales:\n");
